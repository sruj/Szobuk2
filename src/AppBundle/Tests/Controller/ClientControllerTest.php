...
class ClientControllerTest extends WebTestCase
{
    public function testHistoriapanel()
    {
        ...
        $this->assertEquals(200, $client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /purchase-history/");
        ...
        $this->assertEquals(200, $client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /purchase-panel/");
